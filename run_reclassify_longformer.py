...
def main():
    ...
    _model_class = ReClassifyLong
    _trainer_class = RerankerTrainer
    _train_class = GroupedTrainDatasetClassifyLongQry
    _eval_class = PredictionDatasetClassifyLongQry
    _test_class = PredictionDatasetClassifyLongQry
    ...
    if training_args.do_train:
        if trainer.is_world_process_zero():
            ...
            print(data_args)
            print(training_args)
            # case = train_dataset[random.choice(range(train_dataset.__len__()))]
