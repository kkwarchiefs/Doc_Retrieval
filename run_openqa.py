...
def main():
    ...
    _train_class = TrainDatasetOpenQA
    _eval_class = PredictionDatasetOpenQA
    _test_class = PredictionDatasetOpenQA
    ...
    def formate_output(pred_scores, outfile):
        ...
        if trainer.is_world_process_zero():
            ...
            for qid, did, score, lb in zip(pred_qids, pred_pids, pred_scores, labels):
                all_scores[qid][did] = (score, lb)
